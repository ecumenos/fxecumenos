...
func NewWriter(l *zap.Logger, rw http.ResponseWriter, writeLogs bool) Writer {
	return &writer{
		rw:        rw,
		l:         l,
		writeLogs: writeLogs,
